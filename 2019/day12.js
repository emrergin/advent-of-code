...
const jupitersMoons = [{...io,initial:io},{...europa,initial:europa},{...ganymede,initial:ganymede},{...callisto,initial:callisto}];
...
const europa3={x:2, y:-10, z:-7, vel:{x:0,y:0,z:0}, name:'europa'};
const ganymede3={x:4, y:-8, z:8, vel:{x:0,y:0,z:0}, name:'ganymede'};
const callisto3={x:3, y:5, z:-1, vel:{x:0,y:0,z:0}, name:'callisto'};

const jupitersMoons3 = [{...io3,initial:io3},{...europa3,initial:europa3},{...ganymede3,initial:ganymede3},{...callisto3,initial:callisto3}];
...
function resolveCycles(k,moons){
    ...
    for( let steps=0;steps<k;steps++){
        ...
        if(moons[0].y===moons[0].initial.y && moons[1].y===moons[1].initial.y &&  moons[2].y===moons[2].initial.y  && moons[3].y===moons[3].initial.y && cycles[1]===null){
            cycles[1]=steps+1;
            console.log(cycles);
        }
        if(moons[0].z===moons[0].initial.z && moons[1].z===moons[1].initial.z &&  moons[2].z===moons[2].initial.z  && moons[3].z===moons[3].initial.z && cycles[2]===null){
            cycles[2]=steps+1;
            console.log(cycles);
        }

        if(cycles.filter(a=>a===null).length===0){break;}
