...
let commonParent = parentsOfMe.find(a=> parentsOfSanta.find(b => b.parent=== a.parent));

console.log(commonParent.distance + parentsOfSanta.find(b => b.parent=== commonParent.parent).distance-2)
