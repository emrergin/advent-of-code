...
let lines = readFileSync(`day2input.txt`, 'utf-8')
                ...
                .map(a=>({min:+a[0][0], max:+a[0][1], letter:a[1], password:a[2]}));
...
function checkPassword2(line){
    return (((line.password[line.min-1]===line.letter)||(line.password[line.max-1]===line.letter))&&
            ((line.password[line.min-1]!==line.letter)||(line.password[line.max-1]!==line.letter)))  
}
